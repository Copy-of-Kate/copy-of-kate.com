          ...
          <div className="Book">
            <Switch>
              <Route
                ...
                path="/"
                render={props =>
                  <Intro chapters={this.state.chapters} {...props} />}
              />
              <Route
                exact
                path="/chapter/"
                render={props =>
                  <TableOfContents chapters={this.state.chapters} {...props} />}
              />
              <Route
                path="/chapter/:chapter/:title/"
                render={props =>
                  <Chapter chapters={this.state.chapters} {...props} />}
              />
